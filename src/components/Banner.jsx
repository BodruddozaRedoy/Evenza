...
export default function Banner() {
  return (
    <div
      className="h-[500px] rounded-md p-10 bg-no-repeat bg-cover bg-center text-white relative overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="relative z-10 h-full flex items-center flex-col justify-center w-2/4 mx-auto gap-5">
